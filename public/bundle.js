...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__store_configureStore_js__ = __webpack_require__(19);




Object(__WEBPACK_IMPORTED_MODULE_3__store_configureStore_js__["a" /* default */])();
...
var App = (function (_super) {
    ...
    App.prototype.render = function () {
        return (__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "App" }, "Hello World"));
    };
    return App;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_redux_logger__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_redux_thunk__ = __webpack_require__(56);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reducers_repoReducer__ = __webpack_require__(57);
...
var configureStore = function () {
    ...
    var reducers = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["b" /* combineReducers */])({
        repo: __WEBPACK_IMPORTED_MODULE_4__reducers_repoReducer__["a" /* default */]
    });
    // Save our middleare so we can pass this to our store
    var middleware = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["a" /* applyMiddleware */])(Object(__WEBPACK_IMPORTED_MODULE_1_redux_logger__["createLogger"])(), __WEBPACK_IMPORTED_MODULE_3_redux_thunk___default.a);
    // Create a new data store
    var store = Object(__WEBPACK_IMPORTED_MODULE_0_redux__["c" /* createStore */])(reducers, middleware);
    // Test dispatch: 
    ...
    store.dispatch(function (dispatch) {
        ...
        var getUrl = "https://api.github.com/search/repositories?q=de86/luna";
        __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(getUrl)
...
/* WEBPACK VAR INJECTION */(function(global) {!function (e, t) {  true ? t(exports) : "function" == typeof define && define.amd ? define(["exports"], t) : t(e.reduxLogger = e.reduxLogger || {}); }(this, function (e) {
    "use strict";
...
var repoReducer = function (state, action) {
    if (state === void 0) { state = {}; }
    switch (action.type) {
        case "FETCH_REPO_PENDING": {
            return __assign({}, state, { fetching: true, fetched: false });
            break;
        }
        case "FETCH_REPO_SUCCESS": {
            return __assign({}, state, { fetching: false, fetched: true, repos: action.repos });
            break;
        }
        case "FETCH_REPO_FAIL": {
            return __assign({}, state, { fetching: false, fetched: false, error: action.error });
            break;
        }
        default: {
            return state;
...
/* harmony default export */ __webpack_exports__["a"] = (repoReducer);
